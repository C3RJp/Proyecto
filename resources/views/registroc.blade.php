...
<body>
    <form class="m-auto" action="{{route('regC')}}" method="post" class="text-center">
    @csrf
      <div class="text-center">
        <div class="row">
          <div class="col-12">
            <label for="validationDefault01" class="form-label">Cédula</label>
            <input type="number" min="0" max="9999999999" class="form-control" id="validationDefault01" name="cedulaC" required >
          </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="number" min="0" max="9999999999" class="form-control" id="validationDefault04" Name="celularC" required>
          </div>
        </div>
